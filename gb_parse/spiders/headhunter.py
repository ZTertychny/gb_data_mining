...
class HeadhunterSpider(scrapy.Spider):
    ...
    _employer_xpaths = {
        ...
        "shpere_of_activity": "//div[@class='employer-sidebar']//div[@class='employer-sidebar-block']"
        "/p/text()",
    ...
    def parse(self, response, *args, **kwargs):
        ...
        yield from self._get_follow_xpath(
            response, self._hh_xpaths["vacancy"], self.parse_vacancies
        )
    ...
    def parse_vacancies(self, response, *args, **kwargs):
        ...
        yield from self._get_follow_xpath(
            response, self._vacancy_xpaths["hh_employer_url"], self.parse_employer
        )
